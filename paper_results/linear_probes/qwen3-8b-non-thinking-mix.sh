...
probe_dirs=(
    "/home/sinhan-yang/rethinking-calibration/outputs/gsm8k-train__Qwen3-8B-non-thinking__RTXPro6000--merged--triviaqa-train__Qwen3-8B-non-thinking__RTXPro6000/probes/linear__loss-bce__optimizer-sgd__lr-2e-4__lr_scheduler-none__weight_decay-1e-2__batch_size-32__epochs-100__preprocess-false__apply_sigmoid-false__num_samples-14946/layer_mean_pooled/best_probe.pt"
)
eval_datasets=(
    "aime-test"
)
